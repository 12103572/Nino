...
#             c=input("输入您想删除的单词")
#             if c not in d:
#                 print("您输入的单词不在字典中，请重新输入")
#                 break
#             if d[c] in d:
#                 del d[c]
#             print("d=:",d)
#             d=int(input("按0退出，按其余数字可继续删除"))
#             if d == 0:
#                 break
#     if  s==3:
#         while True:
...
#     print("infors=",l)
# print("+"+"-"*16+"+"+"-"*16+"+"+"-"*16+"+")
# print("|"+'姓名'.center(12), "|"+'年龄'.center(12),"|"+'姓名'.center(12)+"|")
# print("+"+"-"*16+"+"+"-"*16+"+"+"-"*16+"+")
# for x in l:
#     print("|"+x["姓名"].center(12),'|'+str(x["年龄"]).center(12),"|"+str(x["成绩"]).center(12)+"|")
#
# print("+"+"-"*16+"+"+"-"*16+"+"+"-"*16+"+")
